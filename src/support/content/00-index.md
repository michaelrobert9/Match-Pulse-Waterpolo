# MatchPulse Support Centre

Everything you need to run a competition on MatchPulse, from setting up your first organisation to finalising a season.

If you're new, start with **Getting Started**. If you're looking for something specific, jump straight to the section.
...
- [Org types: Schools, Clubs, Associations, Franchises](02-organisations-teams/org-types.md)
- [Create an organisation](02-organisations-teams/create-an-organisation.md)
- [Link a parent organisation](02-organisations-teams/link-a-parent-organisation.md)
- [How teams are created and named](02-organisations-teams/how-teams-are-named.md)
- [Add a team](02-organisations-teams/add-a-team.md)
- [Edit a team](02-organisations-teams/edit-a-team.md)
- [Manage your squad and players](02-organisations-teams/manage-your-squad.md)
- [Archive or remove a team](02-organisations-teams/archive-or-remove-a-team.md)

## 3. Competitions
- [Create a competition](03-competitions/create-a-competition.md)
- [Competition naming conventions](03-competitions/naming-conventions.md)
- [Choose a format: league, knockout, hybrid](03-competitions/competition-formats.md)
- [Add teams to a competition](03-competitions/add-teams-to-a-competition.md)
- [Edit a competition](03-competitions/edit-a-competition.md)
- [Competition ownership and authority](03-competitions/ownership-and-authority.md)
...
- [Seed teams into the bracket](05-playoffs/seed-the-bracket.md)
- [Edit the bracket](05-playoffs/edit-the-bracket.md)
- [How teams advance](05-playoffs/how-teams-advance.md)
...
## 8. Permissions & Roles
- [Roles explained: Owner and Scorer](08-permissions/roles-explained.md)
- [Team-scoped vs competition-scoped roles](08-permissions/scoped-roles.md)
