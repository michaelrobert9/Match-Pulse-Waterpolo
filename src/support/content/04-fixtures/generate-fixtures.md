...
- All the teams that should play need to be in the competition. See [Add teams to a competition](../03-competitions/add-teams-to-a-competition.md).
- Decide whether teams play each other once or both home and away.
