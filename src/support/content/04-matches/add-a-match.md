...
A match is a single match between two teams. You can add them one at a time, which is handy for a friendly or a one-off, or generate a whole list at once for a league.

## Before you start

The two teams need to be in the competition already. If they're not, [add them first](../03-competitions/add-teams-to-a-competition.md).
...
3. Click **Add match**.
4. Choose the **home team** and the **away team**.
5. Set the **date and time**.
6. Add a **venue** if you have one.
7. Save.

The match now appears in the match list, ready to be played and scored.
