...
export const teams = {
  'team-wp-sahlm-2526': {
    ...
    goalsFor: 82, goalsAgainst: 61, points: 15,
  },
  'team-kzn-sahlm-2526': {
    ...
    goalsFor: 75, goalsAgainst: 64, points: 13,
  },
  'team-northerns-sahlm-2526': {
    ...
    goalsFor: 69, goalsAgainst: 73, points: 9,
  },
  'team-sg-sahlm-2526': {
    ...
    goalsFor: 56, goalsAgainst: 84, points: 4,
  },
}
...
export const matches = {
  ...
  'match-006': {
    ...
    pitch: 'Pool 2', status: 'scheduled', tracked: false,
  ...
  'match-007': {
    ...
    pitch: 'Pool 1', status: 'scheduled', tracked: false,
    homeScorers: [], awayScorers: [],
  },
  'match-008': {
    id: 'match-008',
